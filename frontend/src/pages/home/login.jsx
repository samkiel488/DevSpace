    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      >
        ...
        <div className={`relative text-white text-center p-8 z-10 transition-all duration-1000 delay-300 ${
          ...
          <h2 className="text-3xl font-bold mb-4 hover:text-blue-300 transition-colors duration-300">
            Welcome Back to DevSpace
          </h2>
          <p className="text-lg hover:text-blue-200 transition-colors duration-300">
